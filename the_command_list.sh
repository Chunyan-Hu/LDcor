...
python scripts/ac_find_indivs_data.py basic_info $1 && # get $1.alt.count.indiv
python write_dots.py basic_info/$1.INFO.uppercaseaa &&
mkdir $1 &&
python scripts/mac_find_indivs_data.py basic_info/ $1 uppercaseaa &&
singularity exec -B /path/to/local/.vep:/home/.vep,/path/to/this/basic_info:/home/basic_info vep.sif vep --cache --offline --species $3 --dir_cache /home/.vep --format vcf -i /home/basic_info/$1.INFO.uppercaseaa.vepinput -o /home/basic_info/$1.vep_output.txt --everything --pick --force_overwrite --fork 8 --cache_version ${5:-101} &&
...
do
	python /media/sheldon/huchy/ani_from_zhou/slim/2.mac_count_all_data_byloci_chr.py basic_info/$4.sample.txt $1/ $1 vep $ii $1/ 
done
echo done
